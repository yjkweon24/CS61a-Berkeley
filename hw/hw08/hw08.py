...
def scale_stream(s, k):
    ...
    helper1 = make_integer_stream(1)
    helper2 = scale_stream(helper1, 5)

    stream_to_list(helper2, 5)
    helper2 = scale_stream(Stream("x", lambda: Stream("y")), 3)
    stream_to_list(helper2)
...
def make_s():
    ...
    def rest():
        ...
        help1 = scale_stream(s, 2)
        help2 = scale_stream(s, 3)
        merge2 = merge(help1, help2)
        help3 =scale_stream(s, 5)

        return merge(merge2, help3)
